      ...
      <footer className="bg-slate-300 text-center text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
        <div className="flex items-center justify-center border-b-2 border-neutral-200 p-6 dark:border-neutral-500 lg:justify-between">
          <div className="mr-12 hidden lg:block">
            <span>Buscanos en las redes:</span>
          </div>
        ...
        <div className="mx-6 py-10 text-center md:text-left">
          <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="">
              ...
              <p>
                Idealmente se usa algun que otro link, como lo es el tw, el
                facebook, whatsapp etc y el Copyright
              </p>
            </div>
            {/* <!-- Products section --> */}
            <div className="">
            ...
            <div className="">
              ...
              <p>
                <a className="text-neutral-600 dark:text-neutral-200">Ayuda</a>
              </p>
            </div>
            {/* <!-- Contact section --> */}
            <div>
